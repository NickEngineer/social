...
public class RelationshipManagerTest extends AbstractCoreTest {
  ...
  private Identity            rootIdentity, johnIdentity, maryIdentity, demoIdentity, ghostIdentity, paulIdentity;
  ...
  public void testGetStatus() throws Exception {
    ...
    assertEquals("rootToDemoRelationship.getStatus() must return: " + Relationship.Type.PENDING,
                 Relationship.Type.PENDING,
                 rootToDemoRelationship.getStatus());
    assertEquals("relationshipManager.getStatus(rootIdentity, demoIdentity) must return: " + Relationship.Type.PENDING,
                 Relationship.Type.PENDING,
    ...
    assertEquals("maryToRootRelationship.getStatus() must return: " + Relationship.Type.PENDING,
                 Relationship.Type.PENDING,
                 maryToRootRelationship.getStatus());
    assertEquals("relationshipManager.getStatus(maryIdentity, rootIdentity) must return: " + Relationship.Type.PENDING,
                 Relationship.Type.PENDING,
    ...
    assertEquals("rootToJohnRelationship.getStatus() must return: " + Relationship.Type.PENDING,
                 Relationship.Type.PENDING,
                 rootToJohnRelationship.getStatus());
    assertEquals("relationshipManager.getStatus(rootIdentity, johnIdentity) must return: " + Relationship.Type.PENDING,
                 Relationship.Type.PENDING,
  ...
  public void testGetConnectionStatus() throws Exception {
    ...
    assertEquals("relationshipManager.getConnectionStatus(rootIdentity, demoIdentity) must return: " + Relationship.Type.PENDING,
                 Relationship.Type.PENDING,
  ...
  /**
   * Test {@link RelationshipManager#invite(Identity, Identity) and
   ...
   * assertNotNull(receiver.getId()); relationshipManager.invite(sender,
   * receiver); List<Relationship> senderRelationships =
   * relationshipManager.getAllRelationships(sender); List<Relationship>
   * receiverRelationships = relationshipManager.getAllRelationships(receiver);
   * assertEquals(total, senderRelationships.size()); assertEquals(total,
  ...
  // public void testIgnore() throws Exception {
  //
  // Relationship relationship = relationshipManager.invite(johnIdentity,
  // rootIdentity);
  // relationshipManager.ignore(relationship);
  // assertNotNull(relationship.getId());
  // assertEquals(Relationship.Type.IGNORED, relationship.getStatus());
  //
  // List<Relationship> senderRelationships =
  // relationshipManager.getAll(johnIdentity);
  // List<Relationship> receiverRelationships =
  // relationshipManager.getAll(rootIdentity);
  //
  // assertEquals(1, senderRelationships.size());
  // assertEquals(1, receiverRelationships.size());
  //
